...
API_ID = int(environ.get('API_ID', '21600420')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'facf5d11a09cc5f4c25a27721e0a137f')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "7739586544:AAGH5W5h-vHs-0dzkcRd47oZ-Z12jkl3dw0")    # Bot token from @BotFather
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002312912446 -1002405634364 -1002676861959').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Kannadacinema:Kannadacinema@cluster0.kjdiquf.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "ravikumar1cn") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Kannada Cinema World') # Collection name (default: dreamcinezone_files)
...
SHORTENER_API = environ.get("SHORTENER_API", "2881ed595d04aa3494123b92cf03dd20633eb015") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "mdiskshort.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "2881ed595d04aa3494123b92cf03dd20633eb015")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "mdiskshort.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "2881ed595d04aa3494123b92cf03dd20633eb015")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "mdiskshort.in") # Shortener website for third website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+LEBoz8OBWTc4ZDBl') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/KCW_Admin_Bot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+cjh8HiYXq80wMTI1') # Update channel link for the bot
